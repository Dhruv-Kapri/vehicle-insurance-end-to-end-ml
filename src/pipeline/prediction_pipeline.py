...
from src.entity import Proj_Estimator, VehiclePredictorConfig
...
class VehicleData:
    ...
    def get_vehicle_data_as_dict(self):
        ...
        """
        logger.info("Entered get_usvisa_data_as_dict method as VehicleData class")
